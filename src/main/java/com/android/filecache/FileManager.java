...
class FileManager {
    ...
    FileManager(Context context) {
        ...
        Log.d(Constants.TAG, "[FileManager]: Initializing new instance");
    }
    ...
    private void validateDir() {
        ...
        if (dir.mkdir()) {
            Log.d(Constants.TAG, "[FileManager]: Create directory: " + mPathCacheDir);
        } else {
            Log.d(Constants.TAG, "[FileManager]: Unable to create directory: " + mPathCacheDir);
        }
    }
    ...
    public void write(String toWrite, String fileName) throws CacheTransactionException {
        ...
        try {
            ...
            out.write(toWrite);
            Log.d(Constants.TAG, "[FileManager]: Writing to " + mPathCacheDir + fileName);
        } catch (IOException e) {
            Log.d(Constants.TAG, "[FileManager]: Unsuccessful write to " + mPathCacheDir + fileName);
            e.printStackTrace();
    ...
    public String readString(String fileName) throws CacheTransactionException {
        ...
        try {
            ...
            Log.d(Constants.TAG, "[FileManager]: Reading from " + mPathCacheDir + fileName);
            return readString;
        } catch (IOException e) {
            Log.d(Constants.TAG, "[FileManager]: Unsuccessful read from " + mPathCacheDir + fileName);
            e.printStackTrace();
    ...
    public JSONObject readJSONObject(String fileName) throws CacheTransactionException {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d(Constants.TAG, "[FileManager]: Successfully read the file " + mPathCacheDir + fileName + ", but was unable to create a JSONObject from the String.");
            throw new CacheTransactionException(Constants.readExceptionAlert);
        }
    }
    ...
    boolean deleteFile(String fileName) {
        Log.d(Constants.TAG, "[FileManager]: Deleting the file " + mPathCacheDir + fileName);
     ...
     * @return isDeleted
     */
    boolean deleteCacheDirContent() {
        Log.d(Constants.TAG, "[FileManager]: Deleting " + mPathCacheDir);
        File dir = new File(mPathCacheDir);
        if (dir.isDirectory()) {
    ...
    boolean hasCacheContent() {
        Log.d(Constants.TAG, "[FileManager]: Checking Content in " + mPathCacheDir);
